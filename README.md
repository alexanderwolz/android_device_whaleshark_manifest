...
This product is currently being tested against *BP1A.250405.007* (android-15.0.0_r26)
...
1. ```repo init -u https://android.googlesource.com/platform/manifest -b android-15.0.0_r26```
